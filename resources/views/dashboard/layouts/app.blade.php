...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('dashboard/svg/favicon.svg') }}" type="image/x-icon">
    ...
    <link rel="stylesheet" href="{{ asset('dashboard/css/app-dark.css') }}">
    <link rel="stylesheet" href="{{ asset('dashboard/css/iconly.css') }}">
</head>
