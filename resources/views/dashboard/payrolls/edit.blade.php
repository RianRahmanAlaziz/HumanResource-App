                    ...
                    <form action="{{ route('payrolls.update', $payroll->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="salary" id="salary" class="form-control"
                                value="{{ $payroll->salary }}" required>
                        </div>

                        <div class="form-group">
                            <label for="bonuses">Bonuses</label>
                            <input type="number" name="bonuses" id="bonuses" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="net_salary" id="net_salary" class="form-control"
                                value="{{ $payroll->net_salary }}" required>
                        </div>

                        <div class="form-group">
                            <label for="pay_date">Pay Date</label>
                            <input type="date" name="pay_date" class="form-control datetimefree"
