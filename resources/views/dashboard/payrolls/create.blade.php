                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('payrolls.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="salary" id="salary" class="form-control" value="7000000"
                                required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="net_salary" id="net_salary" class="form-control" value="8000000"
                                required>
                        </div>
