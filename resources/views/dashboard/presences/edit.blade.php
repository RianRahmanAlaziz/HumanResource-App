                ...
                <div class="card-body">
                    <form action="{{ route('presences.update', $presence->id) }}" method="POST">
                            ...
                            <select name="employee_id" class="form-control" id="employee_id" required>
                                @foreach ($employees as $employee)
                                    <option value="{{ $employee->id }}"
                                        {{ $presence->employee_id == $employee->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" name="check_in" class="form-control datetime" id="check_in"
                                value="{{ old('check_in', $presence->check_in) }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" name="check_out" class="form-control datetime" id="check_out"
                                value="{{ old('check_out', $presence->check_out ? $presence->check_out : '') }}">
                        </div>
