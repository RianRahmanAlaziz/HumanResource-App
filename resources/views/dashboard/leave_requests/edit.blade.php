                    ...
                    <form action="{{ route('leave-requests.update', $leaveRequest->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('leave_type') is-invalid @enderror"
                                name="leave_type" value="{{ old('leave_type', $leaveRequest->leave_type) }}" required>
                            @error('leave_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local"
                                class="form-control @error('start_date') is-invalid @enderror datetime" name="start_date"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local"
                                class="form-control @error('end_date') is-invalid @enderror datetime" name="end_date"
